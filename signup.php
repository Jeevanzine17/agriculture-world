...
<html lang="en">
  <head>
    <title> Farmer   Rental   System || Signup</title>
    <meta charset="utf-8">
...
<?php include_once('includes/header.php');?>
  ...
  function validateMobileNumber() {
    // Get the input value from the field with id "mobilenumber"
...
<div class="form-group">
    <label style="font-weight: bold;">Mobile Number <abbr title="required" class="required">*</abbr></label>
    <input type="tel" placeholder="Mobile Number" id="mobilenumber" name="mobilenumber" maxlength="10" minlength="10" pattern="\d{10}" class="form-control" required onblur="validateMobileNumber()">
</div>
