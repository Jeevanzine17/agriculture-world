...
$propic5=md5($pic5).time().$extension5;
 ...
 $query=mysqli_query($con,"insert into tblproduct(CategoryID,SubcategoryID,ProductName,ModelNumber,RentPrice,PowerSource,ProductDescription,ProductSpecifications,Image,Image1,Image2,Image3,Image4,Image5) value('$catid','$subcatid','$proname','$modelnum','$rentprice','$powersource','$prodesc','$prospec','$propic','$propic1','$propic2','$propic3','$propic4','$propic5')");
...
<head>
    <title> Farmer   Rental   Sysytem | Add Product Details</title>
...
<?php } ?>
    ...
    <input type="text" class="form-control" id="proname" name="proname" required="true" pattern="[A-Za-z\s]+" title="Please enter only letters and spaces.">
</div>

                            <div class="form-group col-md-6">
                                <label for="inputPassword4">Model Number</label>
                               <input type="number" class="form-control" id="modelnum" name="modelnum"  min=1  required="true">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <input type="number" class="form-control" id="renprice" name="renprice" min=0 max=5000 required="true">
                            </div>
                            <div class="form-group col-md-6">
