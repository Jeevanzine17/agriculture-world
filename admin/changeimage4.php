...
$proimg=md5($img).$extension;
    ...
    $query=mysqli_query($con, "update tblproduct set Image4 ='$proimg' where ID='$imgid'");
    if ($query) {
...
?>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <img src="images/<?php echo $row['Image4'];?>" width="200" height="150" value="<?php  echo $row['Image4'];?>">
                            </div>
