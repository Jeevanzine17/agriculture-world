...
<head>
    <title> Farmer   Rental   Sysytem | About Us</title>
...
?>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <textarea class=" form-control" id="pagedes" name="pagedes" type="text" required="true" rows="10" value=""><?php  echo $row['PageDescription'];?></textarea>
                            </div>
