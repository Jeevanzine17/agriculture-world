...
<head>
    <title> Farmer   Rental   System | Approved Booking For Rent</title>
...
<body>
   ...
   <?php include_once('includes/sidebar.php');?>
       ...
       <?php include_once('includes/header.php');?>
            ...
            <!-- main-heading -->
            <h2 class="main-title-w3layouts mb-2 text-center">Approved Booking For Rent</h2>
            <!--// main-heading -->
            ...
            <section class="tables-section">
                ...
                <div class="outer-w3-agile mt-3">
                    <h4 class="tittle-w3-agileits mb-4">Approved Booking For Rent</h4>
