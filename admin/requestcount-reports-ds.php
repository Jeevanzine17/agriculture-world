...
<head>
    <title> Farmer   Rental   System | Request Count Report</title>
...
<body>
   ...
   <?php include_once('includes/sidebar.php');?>
       ...
       <?php include_once('includes/header.php');?>
            ...
            <!-- main-heading -->
            <h2 class="main-title-w3layouts mb-2 text-center">Request Count Report</h2>
            <!--// main-heading -->
            ...
            <section class="tables-section">
                ...
                <div class="outer-w3-agile mt-3">
                    <h4 class="tittle-w3-agileits mb-4">Request Count Report</h4>
                   
      
 
                    <div class="container-fluid">
                        <div class="row">
                          <form class="form-horizontal" method="post" name="bwdatesreport"  action="requestcount-reports-details.php" enctype="multipart/form-data">
