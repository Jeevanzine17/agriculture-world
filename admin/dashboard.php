...
<head>
    <title> Farmer   Rental   Sysytem | Dashboard</title>
...
$totcat=mysqli_num_rows($query2);
?>
                            <div class="s-l">
                                <h5>Total Category</h5>
                                <a class="text-muted text-uppercase m-b-20" href="manage-category.php" style="font-size: 20px"><h6 style="color: black;padding-top: 10px">View</h6></a>
                            </div>
                            <div class="s-r">
                                <h6><?php echo $totcat;?>
                                    <i class="far fa-smile"></i>
                        ...
                        <div class="stat-grid p-3 mt-3 d-flex align-items-left justify-content-between bg-success">
                            <?php $query2=mysqli_query($con,"Select * from tblsubcategory");
$totsubcat=mysqli_num_rows($query2);
?>
                            <div class="s-l">
                                <h5>Total Subcategory</h5>
                                <a class="text-muted text-uppercase m-b-20" href="manage-subcategory.php" style="font-size: 20px"><h6 style="color: black;padding-top: 10px">View</h6></a>
                            </div>
                            <div class="s-r">
                                <h6><?php echo $totsubcat;?>
                                    <i class="far fa-smile"></i>
                                </h6>
                            </div>
                        </div>
