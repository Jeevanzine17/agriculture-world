...
<head>
    <title> Farmer   Rental   Sysytem | Between dates reports</title>
...
<?php } else { ?>                  <td><?php  echo htmlentities($row['Status']);?>
                  ...
                  <?php } ?>     
                  <td><a class="btn btn-sm btn-primary" href="view-booking.php?viewid=<?php echo $row['bid'];?>" target="_blank">View</a>
                </tr>
                <?php 
$cnt=$cnt+1;
}?>                              
