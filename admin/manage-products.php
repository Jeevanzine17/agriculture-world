...
if (strlen($_SESSION['aid']) == 0) {
  ...
  if (isset($_GET['delid'])) {
    ...
    $query = mysqli_query($con, "DELETE FROM `tblproduct` WHERE ID='$rid'");
    if ($query) {
...
<head>
    <title> Farmer   Rental   System | Manage Products </title>
...
<table class="table table-bordered">
    ...
    <tbody>
        <tr data-expanded="true">
            ...
            <td><a class="btn btn-sm btn-primary" href="edit-product.php?editid=<?php echo $row['ID']; ?>">Edit</a>  
