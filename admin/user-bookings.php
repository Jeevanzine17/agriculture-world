...
<head>
    <title> Farmer   Rental   System | User Bookings</title>
...
<body>
   ...
   <?php include_once('includes/sidebar.php');?>
       ...
       <?php include_once('includes/header.php');?>
            ...
            <!-- main-heading -->
            <h2 class="main-title-w3layouts mb-2 text-center"><?php echo $_GET['uname'];?>'s  Bookings</h2>
            <!--// main-heading -->
