...
<head>
    <title> Farmer   Rental   Sysytem | Contact Us</title>
       ...
       <?php include_once('includes/header.php');?>
            ...
            <section class="forms-section">
                ...
                <div class="outer-w3-agile mt-3">
                    <h4 class="tittle-w3-agileits mb-4">Contact Us</h4>
...
?>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="phonenum" class=" form-control" required= "true" value="<?php  echo $row['MobileNumber'];?>" maxlength="10" pattern=[0-9]+>
                            </div>
